...
<div class="card">
  <div class="card-body">
    <h1 class="card-title" style="font-size:30px;">Delivery Boy Master</h1>
            ...
            <tbody>
              ...
              <tr>
                 ...
                 <?php
                  ...
                  <td>
                    <a href="edit_delivery_boy.php?rat=<?php echo $row['id'];?>"><label class="badge badge-success hand_cursor">Edit</label></a>
