...
<div class="card">
  <div class="card-body">
    <h1 class="card-title" style="font-size:30px;">Banner Master</h1>
          ...
          <table id="order-listing" class="table">
            <thead>
              <tr>
                  ...
                  <th style="width:25%;">Sub_heading</th>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                 <a href="edit.banner.php?rat=<?php echo $row['id'];?>"><label class="badge badge-success hand_cursor">Edit</label></a>
                 &nbsp;
                 <?php
               if($row['status']==1){
               ?>
               ...
               ?>
               &nbsp;
              <a href="del_banner.php?sat=<?php echo $row['id'];?>"><label class="badge badge-danger delete_red hand_cursor">Delete</label></a>
            </td>
